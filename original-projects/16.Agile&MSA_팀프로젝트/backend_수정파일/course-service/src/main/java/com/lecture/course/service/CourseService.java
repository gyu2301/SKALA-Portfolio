...
public class CourseService {
    ...
    /**
     * 스드메 상품 등록 (웨딩업체 VENDOR만 가능 - SecurityConfig에서 role 검증)
     */
    @Transactional
    public CourseDto.CourseResponse createCourse(CourseDto.CreateRequest request, Long vendorId) {
    ...
    /**
     * 예약 수 증가 (Enrollment Service 예약 확정 시 호출)
     */
    @Transactional
    ...
    /**
     * 추천 서비스용: 카테고리별 미예약 상품 조회
     * - excludeCourseIds: 이미 예약한 상품 ID 목록
     */
