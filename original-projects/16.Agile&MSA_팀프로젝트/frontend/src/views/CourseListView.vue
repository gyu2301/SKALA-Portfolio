    ...
    <div class="page-layout">
      ...
      <main class="main-content">
        <div class="content-header">
          <div>
            <h1 class="page-title">웨딩 상품</h1>
            <p class="page-subtitle" v-if="isInstructor">
              업체 계정으로 등록한 상품을 확인하고 새 상품을 추가할 수 있습니다.
            </p>
          </div>
        ...
        <!-- 이벤트 카테고리 (EventFIT — 웨딩이 첫 서비스, 나머지는 생애주기 확장 예정) -->
        <div class="event-tabs">
          <button class="event-tab active">💍 웨딩핏</button>
          <button class="event-tab" disabled>👶 출산<span class="soon">준비중</span></button>
          <button class="event-tab" disabled>🎂 돌잔치<span class="soon">준비중</span></button>
          <button class="event-tab" disabled>🎉 환갑<span class="soon">준비중</span></button>
          <button class="event-tab" disabled>🕊️ 장례<span class="soon">준비중</span></button>
        </div>
